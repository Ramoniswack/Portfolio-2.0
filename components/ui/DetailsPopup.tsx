...
export default function DetailsPopup({ open, onClose, title, children }: DetailsPopupProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-start justify-center p-6 sm:p-12">
      <div className="absolute inset-0 bg-black/60 backdrop-blur-sm" onClick={onClose} />
      <div className="relative bg-card max-w-2xl w-full rounded-2xl shadow-xl p-6 z-10">
